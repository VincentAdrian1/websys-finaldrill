...
const ProfilePage: React.FC = () => {
  ...
  <Container className='w-1/2 justify-start' style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh' }}>
    <Box component={Paper} p={4} style={{ backgroundColor: '#333', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', borderRadius: '8px', textAlign: 'center', width: '100%', color: '#fff' }}>
      <Typography variant="h1" gutterBottom>Posts</Typography>
      <Formik
